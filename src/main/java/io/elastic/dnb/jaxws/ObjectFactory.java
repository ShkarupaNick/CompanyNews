 ...
 * generated in the io.elastic.dnb.jaxws package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderProductResponse_QNAME = new QName("http://services.dnb.com/NewsAndMediaProductServiceV2.0", "OrderProductResponse");
    private final static QName _ResultMessage_QNAME = new QName("http://services.dnb.com/TransactionFaultV2.0", "ResultMessage");
    private final static QName _RetrieveProductRequest_QNAME = new QName("http://services.dnb.com/NewsAndMediaProductServiceV2.0", "RetrieveProductRequest");
    private final static QName _TransactionResult_QNAME = new QName("http://services.dnb.com/TransactionFaultV2.0", "TransactionResult");
    private final static QName _OrderProductRequest_QNAME = new QName("http://services.dnb.com/NewsAndMediaProductServiceV2.0", "OrderProductRequest");
    private final static QName _RetrieveProductResponse_QNAME = new QName("http://services.dnb.com/NewsAndMediaProductServiceV2.0", "RetrieveProductResponse");
    private final static QName _ResultDescription_QNAME = new QName("http://services.dnb.com/TransactionFaultV2.0", "ResultDescription");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.elastic.dnb.jaxws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/NewsAndMediaProductServiceV2.0", name = "OrderProductResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ResultMessage2 }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/TransactionFaultV2.0", name = "ResultMessage")
    public JAXBElement<ResultMessage2> createResultMessage(ResultMessage2 value) {
        return new JAXBElement<ResultMessage2>(_ResultMessage_QNAME, ResultMessage2 .class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/NewsAndMediaProductServiceV2.0", name = "RetrieveProductRequest")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TransactionResult2 }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/TransactionFaultV2.0", name = "TransactionResult")
    public JAXBElement<TransactionResult2> createTransactionResult(TransactionResult2 value) {
        return new JAXBElement<TransactionResult2>(_TransactionResult_QNAME, TransactionResult2 .class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/NewsAndMediaProductServiceV2.0", name = "OrderProductRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/NewsAndMediaProductServiceV2.0", name = "RetrieveProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dnb.com/TransactionFaultV2.0", name = "ResultDescription")
